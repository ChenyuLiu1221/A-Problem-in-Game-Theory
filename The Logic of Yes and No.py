...
import math
'''
There are two integers ranging from 1 to 30. Suppose Alice knows the sum of these two integers while Bob knows the product of them. 
...
Question: what are the numbers given to Alice and Bob.
'''
